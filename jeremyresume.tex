...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    { Software Engineer}
    {Nov \apo15 -- present}
    {\bodytext{Responsibilities: Participating in the agile software development life cycle, estimating level of effort, designing software architecture, implementing continuous integration pipelines, supporting QA with test cases, analyzing production crash reports, performing code reviews, writing tests, writing code and fixing bugs.}}
\vspace{0.8em}
  \headedsubsection
  {Avellino iOS - iOS swift}
  {}
  {\bodytext{An iPad application used by physicians to collect patient consent, accession DNA test kits and review patient test results.}}
  
  \headedsubsection
  {Disability Insurance Services - ReactJS Redux}
  {}
  {\bodytext{A web portal used by insurance brokers for cataloging client information and generating different insurance rate proposals.}}

  \headedsubsection
  {Specialty Produce - Xamarin Forms}
  {}
  {\bodytext{A fresh produce encyclopedia and sourcing application.}}
  ...
  {\bodytext{A high performance social network for sharing experiences and exploring your surroundings in real time.}}
   ...
   \headedsubsection
  {San Diego Comic Con - Windows WPF}
  {}
  {\bodytext{OSPA (onsite printing application) a windows desktop application for managing the comic con convention. OSPA's features include bulk printing tickets, checking guests into the event, purchasing new tickets, distributing tickets for companies and more.}}
   ...
   \headedsubsection
  {Script Save Well Rx - Xamarin MvvmCross}
  {}
...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  \headedsubsection
    {Lead iOS Developer}
    {Aug \apo14 -- Nov \apo15}
    {\bodytext{Designed and developed a native iOS app for a social network. Contributed to the backend API design of utilizing AWS dynamoDB and Amazon s3. Administered the app through the App Store approval process.}}
}
