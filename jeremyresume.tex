...
\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  ...
  {Swift, Objective-C, Cocoa, C\#, Xamarin, .Net, C, JavaScript, React, Redux }
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    { }
    {Nov \apo15 -- present}
    {\bodytext{Software Engineer with responsibilities including: participating in the agile software development life cycle, estimating level of effort, designing software architecture, implementing continuous integration pipelines, supporting QA with test cases, analyzing production crash reports, performing code reviews, writing tests, writing code and fixing bugs.}}
